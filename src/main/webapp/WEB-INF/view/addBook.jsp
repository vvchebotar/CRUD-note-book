...
<section class="container">
    <spring:url value="/books/add" var="url">
        <spring:param name="currentPage" value="${currentPage}"/>
    </spring:url>
    <form:form method="POST" modelAttribute="newBook" action="${url}" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                <label class="control-label col-lg-2" for="author">
